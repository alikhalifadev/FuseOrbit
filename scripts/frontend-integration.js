 ...
 * This file demonstrates how to integrate Fuseorbit with a web frontend
 */

// For React/Vue/Angular applications
export class FuseorbitClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FuseorbitClient(provider, contractAddress);
